...
import { AtModal, AtModalHeader, AtModalContent, AtButton, AtModalAction, AtTag } from "taro-ui"
...
class Order extends Component {
    ...
    componentDidShow(){  // onShow
        ...
        this.getAnnexShop(location.latitude,location.longitude)
    ...
    getAnnexShop = (latitude,longitude) => {  // 获取最近的店铺
        qqmapsdk.search({
            keyword: '喜茶',
    ...
    showDetailedSpecifications = (mainId, itemId) => {
    ...
    render() {
        const { VerticalNavTop, list, TabCur, MainCur, chaData } = this.state
        return (
            <View>
                <View className='header'>
                    <View className='shopname' onClick={this.chooseStore}>{this.state.shopInformation.title}<Text className='header-left-direction'> > </Text></View>
                    <View className='header-right'>自取</View>
                </View>

                <View className='header-information'>
                    <View className='header-information-font'>距离您{(this.state.shopInformation._distance / 1000).toFixed(2)}km</View>
                    <View className='header-information-font'>更多门店信息</View>
                </View>

                <View className='main'>
                    <ScrollView className='main-left' scrollTop={VerticalNavTop} scrollY scrollWithAnimation enableBackToTop>
                        {list.map((item, key) => {
                    ...
                    <ScrollView className='main-right' scrollY scrollWithAnimation scrollIntoView={`main-${MainCur}`} onScroll={this.VerticalMain}>
                ...
                <AtModal isOpened={this.state.loginModalFlag} closeOnClickOverlay onClose={this.closeLoginModal}>
                ...
                {
                    this.state.specificationModalFlag == true ?
                        <View className='shoppingModal'>
                            <View className='shoppingDialog'>
                                <View className='close' onClick={this.closeCommodityModal}><Image src={close} /></View>
                                <View className='shoppingImage'><Image src={cha1} /></View>

                                <ScrollView scrollY scrollWithAnimation className='detailedArea'>
                                ...
                                <View className='addShopingCar'>
                                    ...
                                    <View className='addCar'><Button>加入购物袋</Button></View>
                                </View>
                ...
                {
                    this.state.shoppingBagFlag.length == 0 ?
                        <View className='shoppingBag'></View>
                        : ''
                }
